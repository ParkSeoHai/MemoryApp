...
<template>
  <header id="header" class="flex items-center">
    <a href="/" class="logo">
      <svg width="160" height="44" fill="currentColor" aria-labelledby="logo-:R54qbm:" viewBox="0 0 712 105"
      ...
      <li v-for="category in categories" :key="category.id">
        ...
        <div v-if="category.subCategories?.length > 0" class="nav-header__dropdown">
          <div class="nav-header__dropdown--right">
            <ul class="list-link">
              <li>
                <a href="#" class="flex items-center hover:underline px-2 pt-3 text-nowrap">
                  Explore all images
