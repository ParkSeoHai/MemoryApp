    ...
    >
      <div class="grid grid-cols-4">
        ...
        <ul class="flex flex-col gap-2.5 text-[14px] text-[#777777] font-semibold">
          ...
          <li><a href="#" class="block hover:text-white">About us</a></li>
        </ul>
        <div>
          <ul class="flex flex-col gap-2.5 text-[14px] text-[#777777] font-semibold">
            <li class="uppercase text-white">Legal</li>
            <li><a href="#" class="block hover:text-white">Terms of use</a></li>
            <li><a href="#" class="block hover:text-white">License agreement</a></li>
            <li><a href="#" class="block hover:text-white">Privacy policy</a></li>
          </ul>
          <ul class="flex flex-col gap-2.5 text-[14px] text-[#777777] font-semibold mt-4">
            <li class="uppercase text-white">Support</li>
            <li><a href="#" class="block hover:text-white">FAQ</a></li>
            <li><a href="#" class="block hover:text-white">Contact</a></li>
          </ul>
        </div>
        <div>
