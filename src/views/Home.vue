...
const slides = ref([
  {
    img: "https://cdn-front.freepik.com/home/banner-tools-v2/squared/aI-image-gen.webp",
    title: "AI Image Generator",
    desc: "From words to images",
  },
  {
    img: "https://cdn-front.freepik.com/home/banner-tools-v2/squared/aI-image-gen.webp",
    title: "AI Image Generator",
  ...
  <div id="home">
        ...
        <div class="banner-slide flex">
          <div class="banner-slide__left">
            <ul class="flex flex-col items-start gap-3.5 text-[17px] font-semibold">
              ...
              <li class="cursor-pointer hover:text-[#fff] text-[#9c9c9c]">Create</li>
              <li class="cursor-pointer hover:text-[#fff] text-[#9c9c9c]">Edit</li>
              <li class="cursor-pointer hover:text-[#fff] text-[#9c9c9c]">All</li>
            </ul>
          </div>
      ...
      <div class="container">
        ...
        <div class="grid grid-cols-8 gap-7 mt-8">
          <a href="#"
            ...
            <img src="https://cdn-front.freepik.com/home/categories-icons/vectors.svg" class="w-[18px] h-[18px]" />
            <span>Vectors</span>
          </a>
          <a href="#"
            class="flex flex-col items-center justify-center gap-2 font-semibold bg-[#f7f7f7] rounded-lg h-[112px] hover:scale-105"
    ...
    <div class="container">
      <div class="flex items-center justify-center bg-[#f0f4fd] rounded-lg h-[84px]">
        ...
        <button class="btn bg-black" style="color: #fff; padding: 10px 20px; font-size: 15px">
          Sign up now
        </button>
      </div>
    </div>
    ...
    <section class="container home-designers" style="padding-top: 60px; padding-bottom: 40px">
      <div>
        ...
        <div class="home-designers__product grid grid-cols-7 grid-rows-3 gap-7">
          <a href="#"
            class="home-designers__product--item col-span-2 relative h-[220px] rounded-lg font-bold overflow-hidden">
            <img class="hover:scale-105 w-full h-full object-cover" style="transition: scale 0.3s linear"
              src="https://img.freepik.com/free-photo/close-up-rose-flower-details_23-2149417929.jpg?size=626&ext=jpg" />
          ...
          <a href="#"
            class="home-designers__product--item col-span-3 relative h-[220px] rounded-lg font-bold overflow-hidden">
            <img class="hover:scale-105 w-full h-full object-cover" style="transition: scale 0.3s linear"
              src="https://img.freepik.com/free-photo/chinese-new-year-celebration_23-2151936586.jpg?size=626&ext=jpg" />
            <div class="absolute inset-0 pointer-events-none"></div>
            <p class="absolute pointer-events-none z-10 flex items-end inset-0 p-3.5 text-white text-[15px]">
              Rose Photos
            </p>
        ...
        <div class="home-inspired grid grid-cols-4 gap-8 mt-8">
          <div class="flex flex-col gap-8">
            <a href="#" class="home-inspired__item relative overflow-hidden">
              ...
              <div class="absolute flex flex-col justify-end inset-0 pointer-events-none rounded-md p-3.5 text-white">
    ...
    <section class="container">
      <div style="padding: 80px 80px 120px 80px">
        <div class="text-center font-semibold">
          ...
          <button class="btn bg-black mx-auto mt-6 mb-2.5" style="color: #fff; font-size: 15px">
            Sign up for free
          </button>
        </div>
